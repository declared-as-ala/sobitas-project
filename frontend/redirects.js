...
function buildRedirects() {
  ...
  return [
    ...
    /* Keep the exact "mass gainer" intent on the hypercaloric category. Sending this term to
       /gainers-proteines mixed two distinct commercial intents and split the signals already
    ...
    p('/product-category/perte-de-poids/l-carnitine/', '/bruleurs-de-graisse'),
    p('/product-category/prise-de-masse/mass-gainer', '/mass-gainers'),
    p('/product-category/prise-de-masse/mass-gainer/', '/mass-gainers'),
