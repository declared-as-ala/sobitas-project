...
export const legacyArabic: Record<string, string> = {
  ...
  'Qui sommes nous ?': 'من نحن؟',
  "Protein.tn — votre distributeur officiel d'articles de sport et de compléments alimentaires en Tunisie.": 'Protein.tn — موزعكم الرسمي للمعدات الرياضية والمكملات الغذائية في تونس.',
  'Livraison nationale': 'توصيل إلى كامل الجمهورية',
  'Que vous soyez athlète professionnel, passionné de fitness ou débutant — Protein.tn est votre partenaire pour atteindre vos objectifs.': 'سواء كنت رياضيا محترفا أو من محبي اللياقة أو مبتدئا، Protein.tn شريكك لتحقيق أهدافك.',
