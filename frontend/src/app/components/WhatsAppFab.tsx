...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed right-3 bottom-[calc(1.5rem+var(--tabbar-h))] z-40 max-md:[body[data-install-banner]_&]:bottom-[calc(6rem+var(--tabbar-h))] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-md shadow-black/20 ring-1 ring-black/5 transition-all hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] motion-reduce:transition-none sm:right-6 sm:bottom-[calc(1.5rem+var(--tabbar-h))]"
