...
{
    private const DESKTOP_SOURCE = 'returns-desktop-v3.webp';

    private const MOBILE_SOURCE = 'returns-mobile-v3.webp';

    private const DESKTOP_TARGET = 'slides/protein-returns-desktop-20260831-v3.webp';

    private const MOBILE_TARGET = 'slides/protein-returns-mobile-20260831-v3.webp';
    ...
    public function up(): void
    {
        ...
        DB::table('slides')->where('id', 6)->update([
            ...
            'alt' => 'Retour ou échange sous 7 jours chez Protein.tn avec Nitro Tech et créatine Optimum Nutrition',
            'updated_at' => now(),
        ]);
    ...
    public function down(): void
    {
        ...
        DB::table('slides')->where('id', 6)->update([
            'image' => 'slides/protein-returns-desktop-20260831-v2.webp',
            'image_mobile' => 'slides/protein-returns-mobile-20260831.webp',
