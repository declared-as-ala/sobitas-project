...
class InvoiceCalculator
{
     ...
     * @return array
     */
    public static function calculate(array $details, float $remise = 0, float $timbre = 0, float $defaultTva = 19): array
    {
        $totalHt = 0.0;
        $totalTva = 0.0;
        ...
        // Le NET À PAYER est la somme TTC + le Timbre
        $netAPayer = round($ttcArrondi + $timbre, 3);
