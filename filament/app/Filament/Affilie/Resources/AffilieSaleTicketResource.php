...
use App\Filament\Affilie\Resources\AffilieSaleTicketResource\Pages;
...
class AffilieSaleTicketResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('affilie_commission_amount')->label('Commission')->numeric(decimalPlaces: 3)->alignEnd()->placeholder('—'),
                Tables\Columns\TextColumn::make('affilie_code_snapshot')->label('Code')->placeholder('—'),
            ])
    ...
    {
        return [
            'index' => Pages\ListAffilieSaleTickets::route('/'),
        ];
    }
}
