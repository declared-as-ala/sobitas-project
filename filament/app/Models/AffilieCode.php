...
class AffilieCode extends Model
{
    protected $fillable = [
        'affilie_id',
        'code',
    ...
    protected $casts = [
        ...
        'used_count' => 'integer',
        'status' => AffilieCodeStatus::class,
    ];
    ...
    {
        return $this->hasMany(Ticket::class, 'affilie_code_id');
    }

    public function transactions(): HasMany
    {
        return $this->hasMany(AffilieTransaction::class, 'affilie_code_id');
    }

    public function isActive(): bool
    {
        return $this->status === AffilieCodeStatus::Active;
    }
