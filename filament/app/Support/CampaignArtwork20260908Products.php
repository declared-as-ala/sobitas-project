...
/** Atomic, reversible release of the catalogue-accurate campaign products. */
final class CampaignArtwork20260908Products
{
    public const DIRECTORY = 'slide-assets/2026-09-08-products-v3';

    public const ARCHIVE = 'campaign-archives/2026-09-08-products-v3';
    ...
    public const CAMPAIGNS = [
        [
            ...
            'previous' => [
                'image' => 'slides/protein-returns-desktop-20260905-studio-v2.webp',
                'image_mobile' => 'slides/protein-returns-mobile-20260905-studio-v2.webp',
            ],
        ],
        [
            'name' => 'pack-builder',
            'link' => '/pack-builder',
            'previous' => [
                'image' => 'slides/protein-pack-builder-desktop-20260905-studio-v2.webp',
                'image_mobile' => 'slides/protein-pack-builder-mobile-20260905-studio-v2.webp',
            ],
        ],
        [
            'name' => 'welcome-bonus',
            ...
            'previous' => [
                'image' => 'slides/protein-welcome-bonus-desktop-20260905-studio-v2.webp',
                'image_mobile' => 'slides/protein-welcome-bonus-mobile-20260905-studio-v2.webp',
            ],
        ],
    ];
    ...
    public static function target(string $name, string $field): string
    {
        ...
        return "slides/protein-{$name}-{$format}-20260908-products-v3.webp";
    }
