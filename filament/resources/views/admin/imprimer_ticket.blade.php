                ...
                <div class="items">
                    <table>
                        ...
                        <tfoot>
                            ...
                            @if ($ticket->commande && $ticket->commande->coupon_code_snapshot)
                            <tr>
                                <td>Code promo</td>
                                <td></td>
                                <td>{{ $ticket->commande->coupon_code_snapshot }}</td>
                            </tr>
                            <tr>
                                <td>Remise (code promo)</td>
                                <td></td>
                                <td>-{{ number_format((float) ($ticket->commande->discount_ttc ?? $ticket->commande->discount_ht ?? 0), 3, '.', '') }}</td>
                            </tr>
                            @endif
                            <tr>
