...
<body>
    @if (!request()->query('embed'))
    <div class="no-print" style="max-width: 210mm; margin: 12px auto 0; padding: 0 16px; display: flex; justify-content: flex-end; align-items: center; flex-wrap: wrap; gap: 8px;">
