...
<body>
    @if (!request()->query('embed'))
    <div class="no-print" style="max-width: 210mm; margin: 16px auto 0; padding: 0 24px; display: flex; justify-content: flex-end; align-items: center; flex-wrap: wrap; gap: 10px;">
    ...
    <div id="invoice-print" class="invoice-print">
        <header class="m-head">
            <div class="m-head-left">
                <img src="{{ asset('logo.png') }}" alt="Protein.tn" class="m-logo">
                <div class="m-company-name">{{ $coordonnee->abbreviation ?? 'PROTEIN.TN' }}</div>
                @if ($coordonnee)
