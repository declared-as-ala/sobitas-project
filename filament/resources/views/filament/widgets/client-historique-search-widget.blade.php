<x-filament-widgets::widget>
    <x-filament::section class="w-full max-w-full">
        ...
        <x-slot name="description">
            <p class="fi-section-header-description text-sm text-gray-600 mt-0.5">Saisissez le numéro pour afficher tickets, BL, factures TVA et devis.</p>
        </x-slot>
        ...
        <form wire:submit="searchHistorique" class="w-full">
            <div class="fi-fo-grid grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-x-4 md:items-end">
                <div class="fi-fo-field-wrp min-w-0 md:col-span-9 lg:col-span-10">
                ...
                <div class="flex flex-wrap items-center gap-2 min-w-0 md:col-span-3 lg:col-span-2">
                    <button
                        type="submit"
                        wire:loading.attr="disabled"
                        wire:target="searchHistorique"
                        @disabled(!$this->hasValidPhone())
