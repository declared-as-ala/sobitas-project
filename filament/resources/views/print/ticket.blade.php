...
<body>
    ...
    @php
        ...
        $affilieDiscount = (float) ($ticket->affilie_discount_amount ?? 0);
                ...
                <div class="items">
                    <table>
                        ...
                        <tfoot>
                            ...
                            @if($affilieDiscount > 0)
                            <tr>
                                <td>Remise affilié @if($ticket->affilie_code_snapshot)({{ $ticket->affilie_code_snapshot }})@endif</td>
                                <td></td>
                                <td>-{{ number_format($affilieDiscount, 3, '.', '') }}</td>
                            </tr>
                            @endif
