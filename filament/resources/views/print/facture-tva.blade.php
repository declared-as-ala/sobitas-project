...
<table cellspacing="0" cellpadding="0">
    <thead>
        <tr>
            ...
            <th class="text-right" style="width:14%">TOTAL TTC</th>
        </tr>
    </thead>
    <tbody>
        @php $i = 1; @endphp
        ...
        <tr style="{{ $bg }}">
            ...
            <td class="text-center">{{ number_format($row['tva_pct'], 0) }} %</td>
            <td class="text-right">{{ number_format($row['total_ht'], 3, '.', '') }}</td>
            <td class="text-right">{{ number_format($row['total_ttc'], 3, '.', '') }}</td>
        </tr>
        @php $i++; @endphp
        @endforeach
    </tbody>
