{{-- 
  Base A4 layout unifié pour tous les documents imprimés (BL, Facture TVA, Devis, Ticket).
  Variables attendues: 
  - $documentTitle, $documentNumber, $documentDate
  - $client (optionnel)
  - $company (App\Models\Coordinate)
  - $totals (array de lignes ['label','value','class' facultatif])
  - $footerNote, $paymentTerms (optionnels)
  Chaque vue enfant doit définir une section @section('print-table') avec le tableau principal.
--}}
<!DOCTYPE html>
<html lang="fr">
<head>
