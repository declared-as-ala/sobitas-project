...
@php
    ...
    /* Path 1: pre-built $devis_lines (passed by controller) */
...
<style>
/* ═══════════════════════════════════════════════════════════════
   DEVIS — Same design as Facture TVA
...
<header class="ftva-doc-header">
    ...
    <div class="ftva-header-right">
        ...
        <div class="ftva-doc-meta">
            <h1>DEVIS</h1>
            <div class="ftva-doc-meta-badge">Ce devis n'est pas une facture</div>
...
<div class="ftva-bottom">
    ...
    <div class="ftva-note">
        ...
        @if(!empty($noteDevis ?? $coordonnee->note_devis ?? null))
            <br><br>{{ $noteDevis ?? $coordonnee->note_devis }}
        @endif
