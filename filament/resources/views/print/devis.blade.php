...
<head>
    ...
    <title> Devis {{ $documentNumber ?? ($facture->numero ?? '') }}</title>
...
<body>
    ...
    @php
        ...
        $totalTtc = (float) ($calcTotals['net_a_payer'] ?? $facture->prix_ttc ?? 0);
    @endphp
            ...
            <div class="toolbar hidden-print hide_print ">
                <div class="text-right">
                    <button id="printInvoice" class="btn btn-info" onclick="print()"><i class="fa fa-print"></i>
                        Imprimer</button>
                    <a class="btn btn-info" href="{{ $backUrl ?? route('filament.admin.resources.quotations.index') }}"><i
            ...
            <div class="invoice overflow-auto">
                <div style="min-width: 600px">
                    ...
                    <main>
                            ...
                            <table class="table" cellspacing="0" cellpadding="0">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            {{ number_format((float) ($calcTotals['total_ht_brut'] ?? $facture->prix_ht ?? 0), 3, '.', '') }}</th>
                                    </tr>
                                    ...
                                    @if (($calcTotals['remise'] ?? $facture->remise ?? 0) > 0)
                                        <tr>
                                            ...
                                            <th class="text-right">
                                                {{ number_format((float) ($calcTotals['remise'] ?? $facture->remise ?? 0), 3, '.', '') }}</th>
                                        </tr>
                                    @endif
                                    ...
                                    <tr>
                                        <td colspan="2"></td>
                                        <th colspan="3">TVA</th>
                                        <th class="text-right">{{ number_format((float) ($calcTotals['tva'] ?? $facture->tva ?? 0), 3, '.', '') }}
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            {{ number_format($totalTtc, 3, '.', '') }}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <input type="hidden" id="totale" value="{{ number_format($totalTtc, 3, '.', '') }}">
                        ...
                        @if (!empty($noteDevis ?? $coordonnee->note_devis ?? ''))
