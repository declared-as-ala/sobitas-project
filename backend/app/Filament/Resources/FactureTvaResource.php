...
class FactureTvaResource extends BaseResource
{
    protected static ?string $model = FactureTva::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-duplicate';

    protected static ?string $permissionSlug = 'facture_tvas';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('Facture TVA')
                    ->tabs([
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->modalHeading('Edit Facture TVA')
                    ->using(function (FactureTva $record, array $data) {
                        return DB::transaction(function () use ($record, $data) {
                            ...
                            $record->details()->each(function (DetailsFactureTva $detail) {
                ...
                PrintAction::make('voyager.imprimer_facture_tva'),
            ])
            ->bulkActions([
     ...
     */
    protected static function syncDetails(FactureTva $record, array $details): array
    {
        $totalHt = 0.0;
        $totalTva = 0.0;
        $tvaRate = (float) (Coordinate::first()?->tva ?? 0);
        ...
        foreach ($details as $detail) {
            ...
            $detailModel = new DetailsFactureTva();
            $detailModel->facture_tva_id = $record->id;
     ...
     */
    protected static function hydrateClientFromForm(FactureTva $record, array &$data): void
    {
