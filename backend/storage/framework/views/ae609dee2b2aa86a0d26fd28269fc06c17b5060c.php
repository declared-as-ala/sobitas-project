...
<head>
    ...
    <title>Bon de commande <?php echo e(@$facture->numero); ?></title>
</head>
            ...
            <div class="toolbar hidden-print hide_print ">
                <div class="text-right">
                    <button id="printInvoice" class="btn btn-info" onclick="print()"><i class="fa fa-print"></i>
                        Imprimer</button>
                    <a class="btn btn-info" href="<?php echo e(route('voyager.factures.index')); ?>"><i
...
<?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/admin/imprimer_facture.blade.php ENDPATH**/ ?>