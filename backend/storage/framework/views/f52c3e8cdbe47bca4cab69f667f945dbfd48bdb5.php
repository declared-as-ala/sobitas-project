...
<?php $__env->startSection('page_header'); ?>
    <div class="container-fluid">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add', app($dataType->model_name))): ?>
            <?php if($dataType->slug == 'factures'): ?>
                <a href="<?php echo e(route('voyager.facture')); ?>" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
                </a>
            <?php elseif($dataType->slug == 'tickets'): ?>
                <a href="<?php echo e(route('voyager.ticket')); ?>" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
                </a>
            <?php elseif($dataType->slug == 'quotations'): ?>
                <a href="<?php echo e(route('voyager.quotations')); ?>" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
                </a>
            <?php elseif($dataType->slug == 'facture-tvas'): ?>
                <a href="<?php echo e(route('voyager.facture_tva')); ?>" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
                </a>
            <?php elseif($dataType->slug == 'commandes'): ?>
                <a href="<?php echo e(route('voyager.commande')); ?>" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
                </a>
            <?php elseif($dataType->slug == 'product-price-lists'): ?>
            <a href="<?php echo e(route('voyager.pricelists.create')); ?>" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span><?php echo e(__('voyager::generic.add_new')); ?></span>
            </a>
            <?php else: ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', app($dataType->model_name))): ?>
            <?php if($usesSoftDeletes): ?>
                <input type="checkbox" <?php if($showSoftDeleted): ?> checked <?php endif; ?> id="show_soft_deletes"
                    data-toggle="toggle" data-on="<?php echo e(__('voyager::bread.soft_deletes_off')); ?>"
        ...
        <?php if($dataType->slug == 'clients'): ?>

            <a href="<?php echo e(route('voyager.clients.export')); ?>"
            ...
            <div id="modal_importation"
                class="woocommerce xs-modal xs-modal-quick-view xs-quick-view-modal-detail modal fade" tabindex="-1"
                        ...
                        <div class="container" style="direction: ltr;">
                            <div class="row" style="flex-wrap: nowrap; margin-top:22px;">
                                <div class="timeline-steps aos-init aos-animate" data-aos="fade-up"
                                    ...
                                    <div style="margin: 4%">
                                        <form action=" <?php echo e(route('voyager.import', ['slug' => $dataType->slug])); ?> " method="POST"
            ...
            <a href="#" data-toggle="modal" data-target="#modal_sms">
                <button class="btn btn-warning" style="background-color: #FD5820"><i class="bi bi-pen"></i>Envoyer SMS</button>
            </a>
            <div id="modal_sms"
                class="woocommerce xs-modal xs-modal-quick-view xs-quick-view-modal-detail modal fade" tabindex="-1"
                role="dialog" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="min-height: 210px; min-width: 665px;">
                        <div class="modal-header" style="background-color: #FD5820; color:#fff; border-radius: 4px;">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span></button>
                            <h4 class="modal-title">
                                <i class="voyager-window-list"></i> <span></span>
                        ...
                        <div class="container" style="direction: ltr;">
                            <div class="row" style="flex-wrap: nowrap; margin-top:22px;">
                                <div class="timeline-steps aos-init aos-animate" data-aos="fade-up"
                                    style="margin-top:23px; flex-direction:row-reverse;">
                                    <div style="margin: 4%">
                                        <form action=" <?php echo e(route('voyager.send_sms')); ?> " method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="file">Ecriver  votre SMS ici </label>
                                                
                                                <textarea required name="sms" id="" cols="30" rows="10" class="form-control"></textarea>
                                            </div>
              ...
              <a href="#" data-toggle="modal" data-target="#specific_sms">
                <button class="btn btn-warning" style="background-color: #004488"><i class="bi bi-pen"></i>Envoyer SMS (clients spécifiques)</button>
            </a>
            <div id="specific_sms"
                class="woocommerce xs-modal xs-modal-quick-view xs-quick-view-modal-detail modal fade" tabindex="-1"
                role="dialog" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="min-height: 210px; min-width: 665px;">
                        <div class="modal-header" style="background-color: #004488; color:#fff; border-radius: 4px;">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span></button>
                            <h4 class="modal-title">
                                <i class="voyager-window-list"></i> <span></span>
                        ...
                        <div class="container" style="direction: ltr;">
                            <div class="row" style="flex-wrap: nowrap; margin-top:22px;">
                                <div class="timeline-steps aos-init aos-animate" data-aos="fade-up"
                                    style="margin-top:23px; flex-direction:row-reverse;">
                                    <div style="margin: 4%">
                                        <form action=" <?php echo e(route('voyager.specific_sms')); ?> " method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                ...
                                                <select name="clients[]"  class="form-control select2" required multiple>
                                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($client->id); ?>"><?php echo e($client->name); ?> (<?php echo e($client->phone_1); ?> )</option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="sms" id="" cols="30" rows="10" required class="form-control"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary">Envoyer</button>
                                        </form>
                                    </div>
                                ...
                                <div id="search-input">
                                        ...
                                        <select id="search_key" name="key">
                                            <?php $__currentLoopData = $searchNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php if($search->key == $key || (empty($search->key) && $key == $defaultSearchKey)): ?> selected <?php endif; ?>><?php echo e($name); ?>
                                    ...
                                    <div class="col-2">
                                        <select id="filter" name="filter">
                                            <option value="contains" <?php if($search->filter == 'contains'): ?> selected <?php endif; ?>>
                                                <?php echo e(__('voyager::generic.contains')); ?></option>
                                            <option value="equals" <?php if($search->filter == 'equals'): ?> selected <?php endif; ?>>=
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <?php $__currentLoopData = $dataTypeContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <?php if($showCheckboxColumn): ?>
                                                <td>
                                                    <input type="checkbox" name="row_id"
                                                        id="checkbox_<?php echo e($data->getKey()); ?>"
                                            ...
                                            <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td>
                                                    <?php if(isset($row->details->view_browse)): ?>
                                                        <?php echo $__env->make($row->details->view_browse, [
                                                            'row' => $row,
                                                            'dataType' => $dataType,
                                                    ...
                                                    <?php elseif(isset($row->details->view)): ?>
                                                        <?php echo $__env->make($row->details->view, [
                                                            'row' => $row,
                                                            'dataType' => $dataType,
                                                            'dataTypeContent' => $dataTypeContent,
                                                            'content' => $data->{$row->field},
                                                    ...
                                                    <?php elseif($row->type == 'relationship'): ?>
                                                        <?php echo $__env->make('voyager::formfields.relationship', [
                                                            'view' => 'browse',
                                                            'options' => $row->details,
                                                        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <?php elseif($row->type == 'checkbox'): ?>
                                                        <?php if(property_exists($row->details, 'on') && property_exists($row->details, 'off')): ?>
                                                            <?php if($data->{$row->field}): ?>
                                                                <span
                                                                    class="label label-info"><?php echo e($row->details->on); ?></span>
                                                            <?php else: ?>
                                                                <span
                                                                    class="label label-primary"><?php echo e($row->details->off); ?></span>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            <?php echo e($data->{$row->field}); ?>
                                                    ...
                                                    <?php elseif($row->type == 'rich_text_box'): ?>
                                                        <?php echo $__env->make('voyager::multilingual.input-hidden-bread-browse', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <div>
                                                            <?php echo e(mb_strlen(strip_tags($data->{$row->field}, '<b><i><u>')) > 200 ? mb_substr(strip_tags($data->{$row->field}, '<b><i><u>'), 0, 200) . ' ...' : strip_tags($data->{$row->field}, '<b><i><u>')); ?>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                <?php if($dataType->slug == 'factures'): ?>
                                                    <a href="<?php echo e(route('voyager.edit_facture', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.imprimer_facture', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Imprimer</span>
                                                    </a>
                                                <?php elseif($dataType->slug == 'tickets'): ?>
                                                    <a href="<?php echo e(route('voyager.edit_ticket', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.imprimer_ticket', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Imprimer</span>
                                                    </a>
                                                <?php elseif($dataType->slug == 'facture-tvas'): ?>
                                                    <a href="<?php echo e(route('voyager.edit_facture_tva', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.imprimer_facture_tva', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Imprimer</span>
                                                    </a>
                                                    <?php elseif($dataType->slug == 'commandes'): ?>
                                                    <a href="<?php echo e(route('voyager.edit_commande', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.imprimer_commande', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Afficher</span>
                                                    </a>
                                                     <?php elseif($dataType->slug == 'quotations'): ?>
                                                    <a href="<?php echo e(route('voyager.edit_quotation', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.imprimer_quotations', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Afficher</span>
                                                    </a>
                                                     <?php elseif($dataType->slug == 'product-price-lists'): ?>
                                                    <a href="<?php echo e(route('voyager.pricelists.edit', $data->id)); ?>"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="<?php echo e(route('voyager.pricelists.print', $data->id)); ?>"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Afficher</span>
                                                    </a>
                                                <?php else: ?>
                                                    <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(!method_exists($action, 'massAction')): ?>
                                                            <?php echo $__env->make('voyager::bread.partials.actions', [
                                                                'action' => $action,
                                                            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($isServerSide): ?>
                            <div class="pull-left">
                                <div role="status" class="show-res" aria-live="polite">
                                    <?php echo e(trans_choice('voyager::generic.showing_entries', $dataTypeContent->total(), [
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                        aria-label="<?php echo e(__('voyager::generic.close')); ?>"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-trash"></i> <?php echo e(__('voyager::generic.delete_question')); ?>

                        <?php echo e(strtolower($dataType->getTranslatedAttribute('display_name_singular'))); ?>?</h4>
                </div>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script>
        ...
        $('td').on('click', '.delete', function(e) {
            $('#delete_form')[0].action = '<?php echo e(route('voyager.' . $dataType->slug . '.destroy', '__id')); ?>'.replace(
                '__id', $(this).data('id'));
            ...
            $(function() {
                $('#show_soft_deletes').change(function() {
                    if ($(this).prop('checked')) {
                        $('#dataTable').before(
                            '<a id="redir" href="<?php echo e(route('voyager.' . $dataType->slug . '.index', array_merge($params, ['showSoftDeleted' => 1]), true)); ?>"></a>'
                        );
                    } else {
                        $('#dataTable').before(
                            '<a id="redir" href="<?php echo e(route('voyager.' . $dataType->slug . '.index', array_merge($params, ['showSoftDeleted' => 0]), true)); ?>"></a>'
                        );
                    }
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/vendor/voyager/bread/browse.blade.php ENDPATH**/ ?>