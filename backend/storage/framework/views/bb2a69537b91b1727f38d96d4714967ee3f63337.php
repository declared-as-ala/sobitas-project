...
<head>
    ...
    <title>Liste de Prix - <?php echo e(@$pricelist->designation); ?></title>
        ...
        <div id="invoice">
            <div class="toolbar hidden-print hide_print">
                <div class="text-right">
                    ...
                    <a class="btn btn-info" href="<?php echo e(route('voyager.product-price-lists.index')); ?>">
            ...
            <div class="invoice overflow-auto">
                <div style="min-width: 600px">
                    <header style="background: #eeeeee !important;">
                        <div class="row">
                            <div class="col">
                                <img src="<?php echo e(Voyager::image($coordonnee->logo_facture)); ?>"
                                    data-holder-rendered="true" style="width: 220px" />
                                <h4 class="name"><?php echo e($coordonnee->abbreviation); ?></h4>
                                <div><b>Email : </b> &nbsp; <?php echo e($coordonnee->email); ?></div>
                                <div><b>Adresse : </b> &nbsp; <?php echo e($coordonnee->adresse_fr); ?></div>
                                <div><b>Tél : </b> &nbsp;<?php echo e($coordonnee->phone_1); ?>

                                    <?php if($coordonnee->phone_2): ?>
                            ...
                            <div class="col company-details">
                                ...
                                <div class="date"><b>Date :</b> <?php echo e($pricelist->created_at->format('d-m-Y')); ?></div>
                            ...
                            <table class="table" cellspacing="0" cellpadding="0">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $details_pricelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td <?php if($i % 2 != 0): ?> style="background-color: #eee !important" <?php endif; ?>>
                                                <?php echo e($i); ?>
                                            ...
                                            <td <?php if($i % 2 != 0): ?> style="background-color: #eee !important" <?php endif; ?>>
                                             ...
                                             <td class="text-right"
                                                ...
                                                <?php echo e(number_format((float) @$details->prix_gros, 3, '.', '')); ?> DT
                                            </td>
                                            <td class="text-right"
                                                <?php if($i % 2 != 0): ?> style="background-color: #eee !important" <?php endif; ?>>
                                                <?php echo e(number_format((float) @$details->prix_unitaire, 3, '.', '')); ?> DT
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/admin/imprimer_pricelist.blade.php ENDPATH**/ ?>