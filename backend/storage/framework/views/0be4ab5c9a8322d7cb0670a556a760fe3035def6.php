    ...
    <div class="page-content">
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" id="myform" class="form-edit-add" <?php if(@$edit): ?> action="<?php echo e(route('voyager.update_ticket' , @$ticket->id)); ?>"  <?php else: ?> action="<?php echo e(route('voyager.store_ticket')); ?>" <?php endif; ?> method="POST">
                    ...
                    <div class="panel-body">
                                ...
                                <select name="client_id" id="select_client" class="form-control select2"
                                    ...
                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($client->id); ?>" data-adresse="<?php echo e($client->adresse); ?>"
                                            ...
                                            <?php if(@$edit && @$ticket->client_id == $client->id): ?> selected <?php endif; ?>>
                                            <?php echo e($client->name); ?> (<?php echo e($client->phone_1); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <p>Adresse : <input class="form-control" id="adr" disabled
                                        <?php if(@$edit): ?> value="<?php echo e(@$ticket->client->adresse); ?>" <?php else: ?> value="" <?php endif; ?>>
                                </p>
                                <p>N°Tél : <input class="form-control" id="phone" disabled
                                        <?php if(@$edit): ?> value="<?php echo e(@$ticket->client->phone_1); ?>" <?php else: ?> value="" <?php endif; ?>>
                                </p>
                            </div>
                            <!--Client info End-->
                        </div>
                        ...
                        <input type="number" placeholder="barcode" id="barcode"  class="form-control" autofocus onchange="scanner(<?php echo e($produits); ?>)" >
                        <br>
                                                ...
                                                <select name="produit_id_<?php echo e($start); ?>" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($produit->id); ?>"
                                                            ...
                                                            <span><?php echo e(@$produit->code_product); ?></span>
                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </td>
                                            ...
                                            <select name="produit_id_<?php echo e($i); ?>" class="form-control select2"
                                                ...
                                                <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($produit->id); ?>"
                                                        ...
                                                        <?php echo e($produit->designation_fr); ?> ( <?php echo e(@$produit->qte); ?> )
                                                        <span ><?php echo e(@$produit->code_product); ?></span></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </td>
                                        <td>
                                ...
                                <table class="table">
                                    <tr>
                                        ...
                                        <td style="width: 50%"><input name="prix_ht" class="form-control" disabled
                                                id="p_ht" step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$ticket->prix_ht); ?>" <?php else: ?> value="0.000" <?php endif; ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Montant Remise</td>
                                        <td><input name="m_remise" class="form-control" id="m_remise" step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$ticket->remise); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="pourcent_remise" class="form-control" id="pourcen_remise"
                                                <?php if(@$edit): ?> value="<?php echo e(@$ticket->pourcentage_remise); ?>" <?php else: ?> value="0" <?php endif; ?>
                                     ...
                                     <tr id="ligne_apres_remise"
                                      >
                                        ...
                                        <td><input name="apres_remise" class="form-control" id="apres_remise"
                                                step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$ticket->prix_ht - @$ticket->remise); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                                disabled></td>
                                    </tr>
...
function scanner(produits){
    ...
    if(barcode && produits.length>0){
        ...
        if(search){
            ...
            var i = parseInt(document.getElementById('nb_achat').value) - parseInt(document.getElementById('nb_delete').value)
           ...
           i = parseInt(document.getElementById('nb_achat').value) - parseInt(document.getElementById('nb_delete').value)
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/admin/ticket.blade.php ENDPATH**/ ?>