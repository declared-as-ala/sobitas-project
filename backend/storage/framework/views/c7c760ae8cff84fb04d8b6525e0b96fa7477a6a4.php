...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(voyager_asset('images/favicon.png')); ?>" type="image/png">
...
<?php
if (\Illuminate\Support\Str::startsWith(Auth::user()->avatar, 'https://') || \Illuminate\Support\Str::startsWith(Auth::user()->avatar, 'https://')) {
...
<?php /**PATH /home/wajih/Desktop/admin/vendor/tcg/voyager/src/../resources/views/master.blade.php ENDPATH**/ ?>