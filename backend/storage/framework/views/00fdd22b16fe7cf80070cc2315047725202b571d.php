        ...
        <div class="side-menu-container">
            ...
            <div class="panel widget center bgimage"
                ...
                <div class="panel-content">
                    <img src="<?php echo e($user_avatar); ?>" class="avatar" alt="<?php echo e(Auth::user()?->name ?? 'Admin'); ?> avatar">
                    <h4><?php echo e(ucwords(Auth::user()?->name ?? 'Admin')); ?></h4>
...
<?php /**PATH /var/www/html/resources/views/vendor/voyager/dashboard/sidebar.blade.php ENDPATH**/ ?>