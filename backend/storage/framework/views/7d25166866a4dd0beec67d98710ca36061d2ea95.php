<?php $__env->startSection('content'); ?>
    <div class="page-content">
        ...
        <?php if(Auth::user()->role_id == 1 || Auth::user()->role_id == 3): ?>
            <div class="row">
                <div class="col-md-2">
                    <a class="btn btn-success form-control" href="<?php echo e(route('voyager.ticket')); ?>">+ Ajouter Ticket</a>
                </div>
                <div class="col-md-2">
                    <a class="btn btn-primary form-control" href="<?php echo e(route('voyager.facture')); ?>">+ Ajouter BC</a>
                </div>



                <div class="col-md-2">
                    <a class="btn btn-danger form-control" href="<?php echo e(route('voyager.facture_tva')); ?>">+ Ajouter Facture ( TVA
                        )</a>
                </div>
                <div class="col-md-2">
                    <a class="btn btn-warning form-control" href="<?php echo e(route('voyager.clients.create')); ?>">+ Ajouter
                        Client</a>
                </div>
                <div class="col-md-2">
                    <a class="btn btn-primary form-control" style="background-color: rgb(168, 110, 35)"
                        href="<?php echo e(route('voyager.produits.create')); ?>">+ Ajouter Produit</a>
                </div>
                <div class="col-md-2">
                    <a class="btn btn-primary form-control" href="<?php echo e(route('voyager.articles.create')); ?>"
            ...
            <div class=" row">
                ...
                <div class="col-md-4 col-4 col-lg-4">
                    <div class="panel widget center bgimage"
                        style="margin-bottom:0;overflow:hidden; background-image: url(https://admin.sobitas.tn/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F02.jpg);">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-file-text"></i>
                            <h4><?php echo e($new_commandes); ?></h4>
                            <p>Nouvelle Commandes</p>
                            <a href="<?php echo e(route('voyager.commandes.index')); ?>" class="btn btn-primary">Consulter la liste des
                                commandes</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4  col-4 col-lg-4">
                    <div class="panel widget center bgimage"
                        style="margin-bottom:0;overflow:hidden; background-image: url(https://admin.sobitas.tn/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F01.jpg);">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-group"></i>
                            <h4><?php echo e($clients->count()); ?></h4>
                            <p>Clients</p>
                            <a href="<?php echo e(route('voyager.clients.index')); ?>" class="btn btn-primary">Consulter la liste des
                                clients</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4  col-4 col-lg-4">
                    <div class="panel widget center bgimage"
                        style="margin-bottom:0;overflow:hidden;background-image: url(https://admin.sobitas.tn/admin/voyager-assets?path=images%2Fwidget-backgrounds%2F03.jpg);">
                        <div class="dimmer"></div>
                        <div class="panel-content">
                            <i class="voyager-archive"></i>
                            <h4><?php echo e($produits->count()); ?></h4>
                            <p><b>Produits</b></p>
                            <a href="<?php echo e(route('voyager.produits.index')); ?>" class="btn btn-primary">Consulter la liste des
                                produits</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="analytics-container">
                ...
                <div id="g_id_onload" data-client_id="<?php echo e($google_analytics_client_id); ?>"
    ...
    <?php endif; ?>
                 ...
                 <center>
                    <h3>Espace Statistiques <?php if(@$chart1 != null): ?>
                            : <?php echo e(@$chart1->options['chart_title']); ?>

                        <?php endif; ?>
                    </h3>
                </center>
                <form id="contact_form" action="<?php echo e(route('voyager.chart')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row" style="padding: 20px">
                        <?php if(@$chart1 != null): ?>
                        <div class="col-md-6"><?php else: ?><div class="col-md-10">
                        <?php endif; ?>
                        <div class="card" style="padding: 20px;box-shadow:none;">
                                <div class="row">
                                    <label style="color: #000;font-weight: 500;font-size: 20px;">Module : *</label><br>
                                    <?php
                                    ...
                                    $hidden = ['migrations', 'data_rows',
                                    'articles', 'brands' , 'categs' , 'clients', 'commande_details' , 'details_factures','details_tickets','tags', 'menus','faqs','medias',
                                    'sous_categories' , 'services','newsletters','posts' ,'sous_categories','coordinates','contacts','messages','produits','slides','roles',
                                    'data_types', 'menu_items', 'password_resets', 'permission_role', 'personal_access_tokens', 'settings', 'annonces', 'pages', 'aromas'];
                                    ?>

                                    <div class="col-md-12">
                                        <select name="dropdown1" class="form-control" id="dropdown1" onChange="showitems()">
                                            <?php $__currentLoopData = $specific_tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($table->name, $hidden)) continue; ?>
                                                <?php if(@$table->model_name): ?>
                                                    <option value="<?php echo e($table->model_name); ?>"
                                                        <?php if(@$chart1->options['chart_title'] == $table->display_name_singular): ?> selected <?php endif; ?>>
                                                        <?php echo e($table->display_name_singular); ?></option>
                                                <?php endif; ?>
                                ...
                                <div class="row">
                                    <label style="color: #000;font-weight: 500;font-size: 20px;">Sélectionner durée
                                        :</label><br><br>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <label style="color: #000;font-weight: 500;font-size: 20px;">Type affichage :</label><br><br>

                                    <div class="col-md-4">
                                        <input type="radio" id="Rect_Chart" name="chart" value="bar" checked>
                                        <img class="Rectangular-Chart"
                                            src="<?php echo e(voyager_asset('images/Rectangular-Chart.JPG')); ?>"><br><br>
                                        <label for="Rect_Chart">Histogramme</label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" id="Line_Chart" name="chart" value="line">
                                        <img class="Line-Chart" src="<?php echo e(voyager_asset('images/Line-Chart.png')); ?>"><br><br>
                                        <label for="Line_Chart">Liniaire</label>
                                    </div>
                                </div>
                                <button class="btn btn-primary btn-add-new" type="submit" style="height:33px">Exécuter</button>
                            </div>
                        </div>
                        <?php if(@$chart1 != null): ?>
                            <div class="col-md-6">
                                <div class="row card" style="box-shadow:none;padding: 20px">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wajih/Desktop/admin/vendor/tcg/voyager/src/../resources/views/index.blade.php ENDPATH**/ ?>