...
<head>
    ...
    <title> Devis <?php echo e(@$facture->numero); ?></title>
            ...
            <div class="toolbar hidden-print hide_print ">
                <div class="text-right">
                    <button id="printInvoice" class="btn btn-info" onclick="print()"><i class="fa fa-print"></i>
                        Imprimer</button>
                    <a class="btn btn-info" href="<?php echo e(route('voyager.quotations.index')); ?>"><i
                ...
                <div style="min-width: 600px">
                    ...
                    <main>
                        ...
                        <?php endif; ?>
                         ...
                         <?php if(@$coordonnee->note_devis): ?>
                            <div class="notice"> <?php echo e($coordonnee->note_devis); ?>
...
<?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/admin/imprimer_quotations.blade.php ENDPATH**/ ?>