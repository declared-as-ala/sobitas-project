        ...
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" class="form-edit-add" id="myform"
                    <?php if(@$edit): ?> action="<?php echo e(route('voyager.update_facture_tva', @$facture->id)); ?>"  <?php else: ?> action="<?php echo e(route('voyager.store_facture_tva')); ?>" <?php endif; ?>
                    method="POST">
                    ...
                    <?php echo csrf_field(); ?>
                    <input type="hidden"
                        <?php if(@$edit): ?> value="<?php echo e(@$edit_length); ?>" <?php else: ?> value="1" <?php endif; ?> id="nb_achat"
                        name="nb_achat">
                                        ...
                                        <tr id="achat<?php echo e($start); ?>">
                                            ...
                                            <td>
                                                <input type="number" id="qte<?php echo e($start); ?>"
                                                    ...
                                                    <?php if(@$edit): ?> value="<?php echo e(@$details->qte); ?>" <?php else: ?> value="1" <?php endif; ?>
                                                    min="1"
                                                    <?php if(@$edit && @$facture->remise): ?> onkeyup="calculate('m_remise')"
                                                    onchange="calculate('m_remise')"
                                                    <?php else: ?>
                                                    onkeyup="calculate()"
                                                    onchange="calculate()" <?php endif; ?>>
                                            </td>
                                            <td>
                                                <input type="number" step="0.001" min="0"
                                                    <?php if(@$edit): ?> value="<?php echo e(@$details->prix_unitaire); ?>" <?php else: ?> value="0" <?php endif; ?>
                                            ...
                                            <td>
                                                <input type="number" step="0.001" min="0"
                                                    <?php if(@$edit): ?> value="<?php echo e(@$details->prix_ht); ?>" <?php else: ?> value="0" <?php endif; ?>
                                                    name="p_t_ht<?php echo e($start); ?>" class="form-control"
                                                    id="p_t_ht<?php echo e($start); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" step="1" min="0"
                                                    <?php if(@$edit): ?> value="<?php echo e(@$details->tva); ?>" <?php else: ?> value="0" <?php endif; ?>
                                                    name="tva<?php echo e($start); ?>" class="form-control"
                                                    id="tva<?php echo e($start); ?>" disabled>
                                            </td>
                                            <td>
                                                <input type="number" step="1" min="0"
                                                    <?php if(@$edit): ?> value="<?php echo e(@$details->prix_ttc); ?>" <?php else: ?> value="0" <?php endif; ?>
                                                    name="val_tva<?php echo e($start); ?>" class="form-control"
                                                    id="val_tva<?php echo e($start); ?>" disabled>
                                            </td>
                                            <td>
                                    ...
                                    <tr id="achat<?php echo e($i); ?>">
                                        ...
                                        <td>
                                            <input type="number" step="1" min="0" value="0"
                                                name="tva<?php echo e($i); ?>" class="form-control"
                                                id="tva<?php echo e($i); ?>" disabled>
                                        </td>
                                        <td>
                                            <input type="number" step="1" min="0" value="0"
                                                name="val_tva<?php echo e($i); ?>" class="form-control"
                                                id="val_tva<?php echo e($i); ?>" disabled>
                                        </td>
                                        <td>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="m_remise" class="form-control" id="m_remise" step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->remise); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="pourcent_remise" class="form-control" id="pourcen_remise"
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->pourcentage_remise); ?>" <?php else: ?> value="0" <?php endif; ?>
                                                onkeyup="calculate('pourcen_remise')"
                                                onchange="calculate('pourcen_remise')"></td>
                                    </tr>
                                    <tr id="ligne_apres_remise"
                                        <?php if(@$facture->remise || @$facture->pourcentage_remise): ?> style="" <?php else: ?> style="display: none" <?php endif; ?>>
                                        <td>Montant totale HT aprés remise</td>
                                        <td><input name="apres_remise" class="form-control" id="apres_remise"
                                                step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->prix_ht - @$facture->remise); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                                disabled></td>
                                    </tr>
                                    <tr>
                                        <td>Montant Totale TVA</td>
                                        <td><input name="m_totale_tva" class="form-control" step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->tva); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                                disabled id="m_tt_tva"></td>
                                    </tr>
                                    <tr>
                                        <td>Montant Totale TTC </td>
                                        <td><input name="m_totale_ttc" class="form-control" step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->prix_ttc - @$facture->timbre); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input onkeyup="calculate()" onchange="calculate()" name="timbre_fiscal"
                                                ...
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->timbre); ?>" <?php else: ?>  value="<?php echo e($coordonnee->timbre); ?>" <?php endif; ?>>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Net à payer</td>
                                        <td><input name="net_payer" type="number" class="form-control" id="m_net"
                                                step='0.001'
                                                <?php if(@$edit): ?> value="<?php echo e(@$facture->prix_ttc); ?>" <?php else: ?> value="0.000" <?php endif; ?>
                                                disabled></td>
                                    </tr>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SOBITAS-FULL-PROJECT\backend\resources\views/admin/facture_tva.blade.php ENDPATH**/ ?>