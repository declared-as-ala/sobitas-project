...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            ...
            @elseif ($dataType->slug == 'quotations')
                <a href="{{ route('voyager.quotations') }}" class="btn btn-success btn-add-new">
                    <i class="voyager-plus"></i> <span>{{ __('voyager::generic.add_new') }}</span>
                </a>
            ...
            @elseif ($dataType->slug == 'product-price-lists')
            <a href="{{ route('voyager.pricelists.create') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>{{ __('voyager::generic.add_new') }}</span>
            </a>
            @else
        ...
        @if ($dataType->slug == 'clients')

            <a href="{{ route('voyager.clients.export') }}"
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                @elseif ($dataType->slug == 'facture-tvas')
                                                    ...
                                                    <a href="{{ route('voyager.imprimer_commande', $data->id) }}"
                                                     ...
                                                     @elseif ($dataType->slug == 'quotations')
                                                    <a href="{{ route('voyager.edit_quotation', $data->id) }}"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="{{ route('voyager.imprimer_quotations', $data->id) }}"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Afficher</span>
                                                    </a>
                                                     @elseif ($dataType->slug == 'product-price-lists')
                                                    <a href="{{ route('voyager.pricelists.edit', $data->id) }}"
                                                        title="Editer" class="btn btn-warning">
                                                        <i class="voyager-edit"></i> <span
                                                            class="hidden-xs hidden-sm">Editer</span>
                                                    </a>
                                                    <a href="{{ route('voyager.pricelists.print', $data->id) }}"
                                                        title="Editer" class="btn btn-primary">
                                                        <i class="voyager-receipt"></i> <span
                                                            class="hidden-xs hidden-sm">Afficher</span>
                                                    </a>
