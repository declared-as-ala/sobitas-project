...
<head>
    ...
    <title>@yield('page_title', 'Admin Panel') - Sobitas</title>
...
<body class="h-full bg-gray-50 font-sans antialiased">
    ...
    <aside class="admin-sidebar fixed top-0 left-0 z-50 w-[264px] h-screen bg-[#0f172a] flex flex-col" id="adminSidebar" role="navigation" aria-label="Sidebar Navigation">
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-4 space-y-1">
            ...
            {{-- ━━━ MAIN ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Principal'])
                ...
                {{-- 2. Paramètres Du Site (Dropdown) --}}
                @include('layouts.partials.sidebar-dropdown', [
                    'id' => 'site-settings',
            ...
            {{-- ━━━ FACTURATION ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Facturation & Ventes'])

                {{-- 3. Facturations & Tickets (Dropdown - expanded by default) --}}
                @include('layouts.partials.sidebar-dropdown', [
                    'id' => 'billing',
            ...
            {{-- ━━━ CATALOGUE ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Catalogue'])
            ...
            {{-- ━━━ CONTENU ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Contenu'])
            ...
            {{-- ━━━ COMMUNICATION ━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Communication'])
            ...
            {{-- ━━━ SEO & ANALYTICS ━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'SEO & Analytics'])
            ...
            {{-- ━━━ EXPORTS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ --}}
            <div class="mb-3">
                @include('layouts.partials.sidebar-heading', ['title' => 'Outils'])
        ...
        <div class="flex-shrink-0 border-t border-white/[0.06] px-4 py-3">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-slate-200 truncate">{{ Auth::user()->name ?? 'Admin' }}</p>
        ...
        <header class="sticky top-0 z-30 bg-white/80 backdrop-blur-lg border-b border-gray-200/60">
            <div class="flex items-center justify-between h-14 px-4 lg:px-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-sm font-semibold text-gray-900">@yield('page_title', 'Dashboard')</h1>
                        <p class="text-xs text-gray-500 hidden sm:block">@yield('page_subtitle', 'Bienvenue sur le panneau d\'administration')</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- Refresh -->
                    <a href="{{ url()->current() }}" class="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors" title="Rafraîchir">
