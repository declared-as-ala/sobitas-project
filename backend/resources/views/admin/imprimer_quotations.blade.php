            ...
            <div class="toolbar hidden-print hide_print ">
                <div class="text-right">
                    <button id="printInvoice" class="btn btn-info" onclick="print()"><i class="fa fa-print"></i>
                        Imprimer</button>
                    <a class="btn btn-info" href="{{ route('voyager.quotations.index') }}"><i
                ...
                <div style="min-width: 600px">
                    ...
                    <main>
                        ...
                        <div class="table1">
                            <table class="table" cellspacing="0" cellpadding="0">
                                ...
                                <tfoot>
                                    ...
                                    {{--       <tr>
                                        <td colspan="3"></td>
                                        <th colspan="3">Poucentage Remise %</th>
                                        <th class="text-right">{{ @$facture->pourcentage_remise }} %</th>
                                    </tr> --}}
                                    {{--   @if (@$facture->remise || @$facture->pourcentage_remise)
                                        <tr>
                                            <td colspan="3"></td>
                                            <th colspan="3">Montant totale HT aprés remise</th>
                                            <th class="text-right">
                                                {{ number_format((float) @$facture->prix_ht - @$facture->remise, 3, '.', '') }}
                                            </th>
                                        </tr>
                                    @endif --}}
                                    <tr>
                                    ...
                                    {{--     <tr>
                                        <td colspan="3"></td>
                                        <th colspan="3">Montant Totale TTC</th>
                                        <th class="text-right">
                        ...
                        @endif
                         ...
                         @if (@$coordonnee->note_devis)
                            <div class="notice"> {{ $coordonnee->note_devis }}
                            </div>
                            <br>
                        @endif
