        ...
        <div class="analytics-container">
            <div class="Dashboard Dashboard--full">
                <form role="form" class="form-edit-add" id="myform"
                    @if (@$edit) action="{{ route('voyager.update_facture_tva', @$facture->id) }}"  @else action="{{ route('voyager.store_facture_tva') }}" @endif
                    method="POST">
                                        ...
                                        <tr id="achat{{ $start }}">
                                            ...
                                            <td>
                                                <input type="number" step="1" min="0"
                                                    @if (@$edit) value="{{ @$details->tva }}" @else value="0" @endif
                                                    name="tva{{ $start }}" class="form-control"
                                                    id="tva{{ $start }}" disabled>
                                            </td>
                                            <td>
                                                <input type="number" step="1" min="0"
                                                    @if (@$edit) value="{{ @$details->prix_ttc }}" @else value="0" @endif
