...
@section('content')
    <div class="page-content">
        ...
        @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 3)
            ...
            <div class="analytics-container">
                ...
                <div id="g_id_onload" data-client_id="{{ $google_analytics_client_id }}"
    ...
    @endif
                {{-- chart ahmed --}}
                 <center>
                    <h3>Espace Statistiques @if (@$chart1 != null)
                ...
                <form id="contact_form" action="{{ route('voyager.chart') }}" method="POST">
                    ...
                    <div class="row" style="padding: 20px">
                        @if (@$chart1 != null)
                        <div class="col-md-6">@else<div class="col-md-10">
                        @endif
                                            ...
                                            @foreach ($specific_tables as $table)
                                                ...
                                                @if (@$table->model_name)
                                                    <option value="{{ $table->model_name }}"
                                                        ...
                                                        {{ $table->display_name_singular }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <img class="Rectangular-Chart"
                                            src="{{ voyager_asset('images/Rectangular-Chart.JPG') }}"><br><br>
                                        <label for="Rect_Chart">Histogramme</label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="radio" id="Line_Chart" name="chart" value="line">
                                        <img class="Line-Chart" src="{{ voyager_asset('images/Line-Chart.png') }}"><br><br>
