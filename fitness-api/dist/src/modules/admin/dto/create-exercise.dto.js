...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Incline Dumbbell Press' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 90, description: 'Rest time in seconds' }),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateExerciseDto.prototype, "restTime", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Keep elbows at 45 degrees, squeeze chest at top', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateExerciseDto.prototype, "notes", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://youtube.com/watch?v=exercise', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateExerciseDto.prototype, "videoUrl", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Display order index' }),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
