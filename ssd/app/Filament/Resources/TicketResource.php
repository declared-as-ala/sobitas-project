...
class TicketResource extends BaseResource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-o-receipt';

    protected static ?string $permissionSlug = 'tickets';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('Ticket')
                    ->tabs([
                ...
                Tables\Actions\EditAction::make()
                    ...
                    ->using(function (Ticket $record, array $data) {
                        return DB::transaction(function () use ($record, $data) {
                            ...
                            $record->details()->each(function (DetailsTicket $detail) {
     ...
     */
    protected static function syncDetails(Ticket $record, array $details): array
    {
        $totalHt = 0.0;
        ...
        foreach ($details as $detail) {
            ...
            $detailModel = new DetailsTicket();
            $detailModel->ticket_id = $record->id;
     ...
     */
    protected static function hydrateClientFromForm(Ticket $record, array &$data): void
    {
