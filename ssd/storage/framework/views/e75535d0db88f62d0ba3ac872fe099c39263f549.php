                    ...
                    <main>
                            ...
                            <div class="row contacts">
                                <div class="col invoice-to">
                                    ...
                                    <div class="address" > <b>Adresse : </b> &nbsp; <?php echo e(@$facture->adresse1); ?></div>
                                    <?php endif; ?>
                                    <?php if(@$facture->adresse2): ?>
                                    <div class="address" > <b>Adresse 2: </b> &nbsp; <?php echo e(@$facture->adresse2); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->ville): ?>
                                    <div class="address" > <b>Ville: </b> &nbsp; <?php echo e(@$facture->ville); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->region): ?>
                                    <div class="address" > <b>Region: </b> &nbsp; <?php echo e(@$facture->region); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->code_postale): ?>
                                    <div class="address" > <b>Code postale: </b> &nbsp; <?php echo e(@$facture->code_postale); ?></div>
                                    <?php endif; ?>

                                    <div class="email"><a><b>Email :</b> <?php echo e(@$facture->email); ?></a>
                                    </div>
                                    <div class="email"><a><b>Numéro de téléphone :</b> <?php echo e(@$facture->phone); ?></a>
                                    </div>
                                ...
                                <div class="col invoice-details">
                                    ...
                                    <div class="address" > <b>Adresse : </b> &nbsp; <?php echo e(@$facture->livraison_adresse1); ?></div>
                                    <?php endif; ?>
                                    <?php if(@$facture->livraison_adresse2): ?>
                                    <div class="address" > <b>Adresse 2: </b> &nbsp; <?php echo e(@$facture->livraison_adresse2); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->livraison_ville): ?>
                                    <div class="address" > <b>Ville: </b> &nbsp; <?php echo e(@$facture->livraison_ville); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->livraison_region): ?>
                                    <div class="address" > <b>Region: </b> &nbsp; <?php echo e(@$facture->livraison_region); ?></div>
                                    <?php endif; ?>

                                    <?php if(@$facture->livraison_code_postale): ?>
                                    <div class="address" > <b>Code postale: </b> &nbsp; <?php echo e(@$facture->livraison_code_postale); ?></div>
                                    <?php endif; ?>

                                    <div class="email"><a><b>Email :</b> <?php echo e(@$facture->livraison_email); ?></a>
                                    </div>
                                    <div class="email"><a><b>Numéro de téléphone :</b> <?php echo e(@$facture->livraison_phone); ?></a>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <table class=" table" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php $__currentLoopData = $details_facture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-right"
                                              ...
                                              <td class="text-right"
                                                <?php if($i % 2 != 0): ?> style="background-color: #eee !important" <?php endif; ?>>
                                                <?php echo e(number_format((float) @$details->prix_ttc, 3, '.', '')); ?></td>
                                        </tr>
                                        <?php
                                            $i++;
                                        ?>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            <?php echo e(number_format((float) @$facture->frais_livraison, 3, '.', '')); ?></th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right" style=" background: #2465ac3d !important;">
                                            <?php echo e(number_format((float) @$facture->prix_ttc , 3, '.', '')); ?>
